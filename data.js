(function() {
        ...
        ventas.forEach(venta => {
            ...
            (venta.productos || []).forEach(p => {
                 ...
                 if (p.cantidadVendida) { 
                     ...
                     // Se usaba 'p.unidadesPorCaja' (del objeto de venta, que puede ser 1 o undefined)
                     // en lugar de 'prodParaReporte.unidadesPorCaja' (del snapshot de inventario).
    ...
    async function loadAndDisplayMap() {
        ...
        try {
            ...
            // --- INICIO DE LA CORRECCIÓN ---
            // La URL del ícono azul (blueI) estaba incorrecta.
            // Apuntaba a la URL del "tile" del mapa (https{s}.tile...) en lugar de la imagen del marcador.
